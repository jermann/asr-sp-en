...
# apj2125: uncomment below if you want to delete all the intermediary steps to re-run the code
...
if [ $stage -le 0 ]; then
  ...
  # Author: apj2125
  # TA Note: Only uncomment if you would like to download all the data again
  # ====== Download Miami to Kaldi =======
...
# Author: apj2125
# Note: The below section was taken from WSJ Run.sh, but adapted to be Class based
# n-gram. Added another in-line comment below to point this out.
if [ $stage -le 4 ]; then
  echo
  echo "===== TRAINING LM ====="
  echo "===== MAKING lm.arpa ====="
